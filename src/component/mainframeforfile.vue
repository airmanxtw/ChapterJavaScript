...
export default {
  ...
  watch: {},
  computed: {
    ...mapState(["isguest", "absURL", "loginuser", "activeid"]),
  },
  components: {
    "login-panel": function (resolve) {
      require(["./login-panel.vue"], resolve);
    },
  },
  created: function () {
    var THIS = this;
