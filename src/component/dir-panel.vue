<template>
    <div>        
        <div class="pb-8">
            <div v-if="canmodify">
                <v-btn color="blue-grey" @click.stop="openCreateDir"
                ...
                <fileupload-button ref="fileuploadbutton" :activeid="activeid" @uploads="fileuploads">上傳檔案</fileupload-button>
            </div>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <v-form ref="dirform" lazy-validation>
                            <v-text-field v-model="currentDIR.name"
                                          :counter="20"
                                          :rules="nameRules"
                                          label="目錄名稱"
                                          required>
                            ...
                            <v-slider v-model="currentDIR.sortby"
                                      min="0" max="100"
                    ...
                    <v-card-actions>
                        <v-checkbox color="red" label="刪除此目錄" v-if="candel" v-model="todel"></v-checkbox>
                        <v-spacer></v-spacer>


                        <v-btn color="green darken-1" @click="dirdialog=false" text>
                            取消
                        </v-btn>
            ...
            <v-list dense>
                ...
                <v-list-item v-show="canopen" v-for="dir in directorys" :key="dir.id" @click.stop="listitemclick(dir.id)" two-line>
                    <v-list-item-icon>
                        <v-icon v-text="dir.icon" large></v-icon>
                    </v-list-item-icon>
                    <v-list-item-content>
                        <v-list-item-title class="text-md-body-1" v-text="dir.name"></v-list-item-title>
