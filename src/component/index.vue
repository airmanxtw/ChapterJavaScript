...
export default {
  ...
  methods: {
    ...
    getalldirectorys: function (_activeid) {
      ...
      THIS.axios
        .get(this.absURL + "api/Dir/ALLDIRECTORY", {
        ...
        .then(function (response) {
          ...
          if (THIS._activeid != undefined) {
            ...
            THIS.axios
              .get(THIS.absURL + "api/Open", {
                params: { info: THIS.loginuser.info, activeid: THIS._activeid },
              })
              .then(function (response) {
  ...
  computed: {
    ...mapState(["absURL", "loginuser", "actionURL"]),
  },
  components: {
    DirNavigation,
    DirPanel,
